export default function OfficePhotoSection({ t }) {
  const copy = {
    imageAlt: t?.officePhotoSection?.imageAlt ?? "Orozco Law Firm team",
    caption:
  ...
  return (
    <section className="mx-auto w-full max-w-screen-2xl px-4 sm:px-6 pb-16">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-3xl bg-white/70 shadow-xl ring-1 ring-black/5 backdrop-blur-sm">
        <img
