export default function FooterSection({ t }) {
    const copy = {
      ...
      phoneHref: t?.siteFooter?.phoneHref ?? "tel:+16197361268",
      phoneAria: t?.siteFooter?.phoneAria ?? "Call Orozco Law Firm",
      rights: t?.siteFooter?.rights ?? "All rights reserved.",
    };
        ...
        <div className="border-t border-black/10 bg-white/90 backdrop-blur-sm">
          <div className="mx-auto max-w-6xl px-6 py-10">
            ...
            <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-xs text-brand-gray">
              ...
              <a href="/do-not-sell" className="hover:underline">
